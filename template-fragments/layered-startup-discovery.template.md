...
|------------|----------------|
| Check deacon work | `gc bd list --assignee={{ .BindingPrefix }}deacon --include-infra --json` |
| Check the deacon patrol wisp | `gc bd list --assignee={{ .BindingPrefix }}deacon --type=molecule --include-infra --title=mol-deacon-patrol --limit=0 --json` |
