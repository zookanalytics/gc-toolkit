...
This distills the working foundation in `docs/escalation-foundation.md` and the
pack thesis in `docs/roadmap.md`, with supporting direction from
`docs/escalation/marching-orders.md`, `docs/escalation/roadmap.md`,
`docs/escalation/selection-menu.md`, `docs/gas-city-pack-v2.md`, and
