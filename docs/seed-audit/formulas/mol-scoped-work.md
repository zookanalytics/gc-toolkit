...
Steps (28):
  ...
  ├── mol-scoped-work.body: Worktree body scope [needs: mol-scoped-work.workspace-setup-scope-check, mol-scoped-work.preflight-tests-scope-check, mol-scoped-work.implement-scope-check, mol-scoped-work.self-review-scope-check, mol-scoped-work.submit-scope-check]
  ...
  └── mol-scoped-work.workflow-finalize: Finalize workflow [needs: mol-scoped-work.body, mol-scoped-work.cleanup-worktree]
