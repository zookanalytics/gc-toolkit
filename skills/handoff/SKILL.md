...
This skill has two shapes. Pick one by reading `$GC_TEMPLATE`, checking
...
This step is shared by both paths (canonical and thread
hand-up). Inventory first, then apply the path-specific
