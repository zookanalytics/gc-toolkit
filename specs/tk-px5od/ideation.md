...
Full report: `research/v1-red-team.md`. Three load-bearing structural
...
Full reports: `research/v2-ai-native-prior-art.md`,
`research/v4-ai-native-inventions.md`.
...
V3 (full report: `research/v3-skeptic.md`) names the structural
