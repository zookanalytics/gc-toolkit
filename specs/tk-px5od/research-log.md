...
Report: `research/r1-toyota-production-system.md`. All 13
...
Report: `research/r2-cheap-prototyping.md`. Load-bearing finding:
...
Report: `research/r3-cheap-photography-curation.md`. P3 grounded
...
Report: `research/r4-recovery-oriented-computing.md`. Key finding:
...
Report: `research/r5-amazon-coe.md`. Key findings: what COE
