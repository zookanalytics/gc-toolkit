...
> (`../../docs/foundation.md`) first; this doc fills in the strategic
...
`roadmap.md`. The most consequential items there:
...
- **Foundation:** `../../docs/foundation.md` — the canonical doc;
  start there.
- **Ideation breadth:** `ideation.md` — full inventory
  of candidates considered (~150).
- **Selection menu:** `selection-menu.md` — earlier
  attempt at organizing the ideation for curation; superseded by this
  marching-orders doc and the foundation updates.
- **Research:** `research/` — five domain reports
...
- **Research log:** `research-log.md` — index of which
  reports cover what.
- **Roadmap:** `roadmap.md` — phased / future items.
