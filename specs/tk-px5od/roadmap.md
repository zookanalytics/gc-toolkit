...
From V7 (`research/v7-hidden-metrics.md`). The pack's
...
From V4 (`research/v4-ai-native-inventions.md`):
...
From V5 (`research/v5-inversions-within.md`) and V6
(`research/v6-inversions-against-field.md`). The
