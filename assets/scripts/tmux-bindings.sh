...
# Zortex board — the sibling of prefix+S. prefix+S answers "what's
...
# (bead tk-qkags; design Key Component 4). See tmux-pick-zortex.sh.
gcmux bind-key b run-shell "$CONFIGDIR/assets/scripts/tmux-pick-zortex.sh --city-path $(sq "$CITY_PATH")"
